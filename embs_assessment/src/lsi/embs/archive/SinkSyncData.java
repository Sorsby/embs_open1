...
/**
 * Stores the parameters and other data about a sink node
 */
public class SinkSyncData {
     ...
     * Lower bound for Δt
     */
    public static final long DELTA_T_LOWER = 500;
    ...
    public void receiveBeacon(long absoluteTime, int n) {
        ...
        if (prevN != 0 && deltaT > 0) {
            //is N in the same iteration
            //deltaN will be positive, and deltaT will be less than the time for one entire iteration with the minimum possible deltaT for the current bestN.
